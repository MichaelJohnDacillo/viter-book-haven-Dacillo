            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-4">
              ...
              {activeAccordion === 0 && (
                <div className="px-6 pb-6 text-gray-600">
                    <p>
                        Standard shipping typically takes 3-5 business days within the continental US. We also offer expedited shipping options at checkout for faster delivery.
                    </p>
                </div>
              )}
            </div>
              ...
              {activeAccordion === 2 && (
                <div className="px-6 pb-6 text-gray-600">
                    <p>
                      ...
                      refund. Books must be in new, unread condition with
                      original packaging. Please contact our customer service to
                      initiate a return.
                    </p>
                </div>
              )}
